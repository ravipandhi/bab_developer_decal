...
contract CosmosBank {
    ...
    */
        ...
        returns(address)
    {
        ...
        //     msg.sender,
        //     "in the method of deploynewbridge token, now increasing count"
        // );
        ...
        // emit wherethecontrolis(
        //     msg.sender,
        //     "count increased by 1, now deploying new bridge token"
        // );
        // Deploy new bridge token contract
        BridgeToken newBridgeToken = new BridgeToken("TOK");

        // emit wherethecontrolis(
        //     msg.sender,
        //     "newbridgetoken created, fetching its address now"
        // );
    ...
    function deployNewBridgeTokenMod(
        ...
        returns(address)
    {
        ...
        //     "whitelisting now"
        // );
        bridgeTokenWhitelist[_token_con_address] = true;
